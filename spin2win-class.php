    ...
    */
    function wpdocs_register_my_custom_menu_page() {
        add_menu_page( 
            ...
            plugins_url( 'spin2win-popup/admin/spin2winsmall.png' ),
            6
        );
...
class SPIN2WIN_PublicClass{
    ...
    public function spin_2_win_add_scripts() {
        wp_enqueue_script( 'bootstrap-js', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.4/js/bootstrap.min.js', array('jquery'), '201709061', true );
